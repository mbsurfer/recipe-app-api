...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Foo Recipe')
        recipe2 = sample_recipe(user=self.user, title='Bar Recipe')
        tag1 = sample_tag(user=self.user, name='Foo Tag')
        tag2 = sample_tag(user=self.user, name='Bar Tag')
        recipe1.tags.add(tag1)
        recipe2.tags.add(tag2)
        recipe3 = sample_recipe(user=self.user, title='Baz Recipe')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Foo Recipe')
        recipe2 = sample_recipe(user=self.user, title='Bar Recipe')
        ingredient1 = sample_ingredient(user=self.user, name='Foo Ingredient')
        ingredient2 = sample_ingredient(user=self.user, name='Bar Ingredient')
        recipe1.ingredients.add(ingredient1)
        recipe2.ingredients.add(ingredient2)
        recipe3 = sample_recipe(user=self.user, title='Baz')
